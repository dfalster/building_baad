...
%-----------------------------------
\begin{frame}\frametitle{\color{b-blue} Global compilation}
...
%-----------------------------------
\begin{frame}\frametitle{ Why: \color{b-blue} We needed data}
\begin{tikzpicture}[remember picture, overlay]
...
\begin{frame}
  \herohigh{How we {\color{b-pink} built BAAD}}
  \begin{tikzpicture}[remember picture, overlay]%
...
\begin{frame}
  \herohigh{\color{b-pink} 7. Review}
  \bottomhangingborder{
...
\begin{frame}\frametitle{\color{b-blue} New techniques for modern ecology}
\begin{tikzpicture}[remember picture, overlay]
